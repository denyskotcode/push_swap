...
void		get_b_moves(t_list *stack_b,
				int value, t_move_cost *cost, int size);
...
t_move_cost	*calculate_cost(t_list *stack_a,
				t_list *stack_b, int value, int size);
void		execute_moves(t_move_cost *cheapest,
